...
# Setup
#
$query = 'SELECT name,url FROM '.cms_db_prefix().'module_yandexmaps_icons ORDER BY name';
...
$map = yam_map_operations::load_by_id($map_id,true);
if( !$map ) {
  echo $this->ShowErrors($this->Lang('error_invalidparams'));
  return;
}
...
if( isset($params['cancel']) ) {
    ...
    // handle the submit
    //
    $marker = yam_marker_operations::load_marker_from_data($params);
