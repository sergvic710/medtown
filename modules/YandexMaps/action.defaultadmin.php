...
if( $this->CheckPermission('Manage Maps') || $this->CheckPermission('Manage Map Locations') ) {
...
if( $this->CheckPermission('Manage Maps') || $this->CheckPermission('Manage Map Locations') ) {
  ...
  include(__DIR__.'/function.admin_maps_tab.php');
  echo $this->EndTab();
}
if( $this->CheckPermission('Modify Site Preferences') ) {
  echo $this->StartTab('icons');
  include(__DIR__.'/function.admin_icons_tab.php');
  echo $this->EndTab();
