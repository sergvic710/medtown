(function($){
  $.widget('sergvic.yam', {
    ...
    // combine_points, point_combine_fudge, combined_icon, default_icon, idle_cb, mylocation, youareherestr
	...
	var map = new ymaps.Map("yam_map_1", {
            center: [59.98,30.34], 
            zoom: 12
        });
	myPlacemark = new ymaps.Placemark([59.98,30.34], { content: 'Москва!', balloonContent: 'Столица России' });
...
/*	  var mapOptions = this._getMapOptions();
	  ...
	  if( this.options.zoom_encompass > 0 ) {
